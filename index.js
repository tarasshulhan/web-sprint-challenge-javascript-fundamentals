...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
  // The nested function is able to acess the variable internal, because the variable belongs to the
  // nested funtion's parent function. This works because of closure.
...
const zooAnimals = [
  ...
  */
  ...
  function USApop(arr){
    const pops = arr.map(element => element.population);
    const reducer = (previousValue, currentValue) => previousValue + currentValue;
    return pops.reduce(reducer);
  }
